  ...
  render() {
    ...
    return (
      <KeyboardAvoidingView behavior='padding' style={styles.container}>
        ...
        <TextInput style={styles.input} placeholder="Enter question/facts" value={q} onChangeText={(input) => this.setState({ q: input })} />
        <Text>Write answer</Text>
        <TextInput style={styles.input} placeholder="Enter Answer" value={a} onChangeText={(input) => this.setState({ a: input })} />
        <TouchableOpacity
